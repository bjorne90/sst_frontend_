                ...
                <div className="tp-bt-btn-banner d-none d-md-block d-xl-none mr-30">
                  ...
                  <svg
                    ...
                    >
                      ...
                      <circle cx="7" cy="2" r="2" fill="#cdad00" />
                      <circle cx="12" cy="2" r="2" fill="#F44336" />
                      <circle cx="12" cy="7" r="2" fill="#cdad00" />
                      <circle cx="12" cy="12" r="2" fill="#F44336" />
                      <circle cx="7" cy="7" r="2" fill="#cdad00" />
                      <circle cx="7" cy="12" r="2" fill="#F44336" />
                      <circle cx="7" cy="17" r="2" fill="#cdad00" />
                      <circle cx="2" cy="7" r="2" fill="#F44336" />
                      <circle cx="2" cy="12" r="2" fill="#cdad00" />
                    </svg>
                    <span>Kontakta oss :</span>+91 590 088 55
                  </a>
                </div>
                <button
              ...
              <div className="col-xxl-3 col-lg-3 d-flex align-items-center justify-content-end">
                <div className="tp-bt-btn-banner">
                  <a className="tp-bt-btn" href="tel:123456">
                    ...
                    <span>Kontakta oss: </span>0705 - 88 87 42
                  </a>
                </div>
              </div>
            </div>
