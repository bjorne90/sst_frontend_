...
const gallery_content = [
  {
    id: 1,
    img: "assets/img/gallery/gallery1.jpeg",
    text1: "HLR Utbildning",
    text: "HLR Utbildning",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    img: "assets/img/gallery/gallery2.jpeg",
    text1: "Sköterskor på BigSlap",
  },
  {
    id: 4,
    img: "assets/img/gallery/gallery3.jpeg",
    text1: "Tjejerna på bigslap",
  },
  {
    id: 5,
    img: "assets/img/gallery/gallery5.jpeg",
    text1: "Martin vid en ambulans",
  },
];
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="tp-section text-center">
                ...
                <h3 className="tp-section__title mb-70">Senaste från Instagram</h3>
              </div>
            </div>
          </div>
        </div>
