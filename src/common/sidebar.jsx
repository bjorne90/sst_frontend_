    ...
    <>
      ...
      >
        ...
        <div className="tpsideinfo__content mb-60">
          ...
          <a href="#">
            <i className="fa-solid fa-star"></i>Sockervägen 1, Kävlinge
          </a>
          <a href="tel:61383766284">
            <i className="fa-solid fa-star"></i>0705-87 85 31
          </a>
          <a href="mailto:info@skanessjukvardstjanst.se">
            <i className="fa-solid fa-star"></i>info@skanessjukvardstjanst.se
          </a>
        </div>
